...
#       define BITS_ACCEL_FS_MASK                   0x18 // only bits 3 and 4 are used for accel full scale so use this to mask off other bits
#       define BITS_ACCEL_ZGYRO_SELFTEST            0x20
#       define BITS_ACCEL_YGYRO_SELFTEST            0x40
#       define BITS_ACCEL_XGYRO_SELFTEST            0x80
